...
// const capitalEngland2 = capitalEngland.charAt(0).toUpperCase() + capitalEngland.substring(1).toLowerCase();
// const capitalFrance2 = capitalFrance.charAt(0).toUpperCase() + capitalFrance.substring(1).toLowerCase();
// const capitalGermany2 = capitalGermany.charAt(0).toUpperCase() + capitalGermany.substring(1).toLowerCase();
